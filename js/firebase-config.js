...
import { getFirestore, collection, addDoc, getDocs, deleteDoc, doc, query, orderBy, limit, updateDoc, onSnapshot, where } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-firestore.js";
...
export { db, collection, addDoc, getDocs, deleteDoc, doc, query, orderBy, limit, updateDoc, onSnapshot, where };
